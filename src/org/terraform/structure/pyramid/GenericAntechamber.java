...
public class GenericAntechamber extends Antechamber {
    ...
    public void populate(PopulatorDataAbstract data, CubeRoom room) {
    	...
    	for(int i = 0; i < GenUtils.randInt(2, 5); i++) {
    		...
    		data.setType(coords[0], room.getY()+1, coords[2], GenUtils.randMaterial(Material.CHISELED_SANDSTONE,Material.CHISELED_SANDSTONE,Material.CHISELED_SANDSTONE,Material.BONE_BLOCK));
    	}
    	...
    	//Dead corals
    	Material[] deadCorals = new Material[] {
    	...
    	//Logs
    	if(GenUtils.chance(rand,1, 2))
	    	randomRoomPlacement(data,room,1,5,new Material[] {
	    			Material.ACACIA_LOG,
	    			Material.BIRCH_LOG,
    	...
    	if(GenUtils.chance(1, 3)) {
        	randomRoomPlacement(data,room,1,1,new Material[] {
