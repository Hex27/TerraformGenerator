...
public class NMSChunkGenerator extends ChunkGenerator {
	...
	public NMSChunkGenerator(String worldname, long seed,
        ...
        twpb = new TerraformWorldProviderBiome(tw, delegate.c());
    		...
    		WorldGenStage.Features worldgenstage_features)
    {
        ...
        ichunkaccess.a(this.twpb, null); //This can be null as its passed into twpd
        	...
        	for (int x = 0; x < 16; x++) {
                for (int z = 0; z < 16; z++) {
                    ...
                    while(!CraftBlockData.fromData(ichunkaccess.a_(new BlockPosition(rawX, height, rawZ))).getMaterial().isSolid()
                		...
                		ichunkaccess.a(new BlockPosition(rawX, height, rawZ), Blocks.a.o(), false); //Blocks.AIR.defaultBlockState()
                    	height--;
                    }
