...
public class TerraStructureStart extends StructureAbstract {
	...
	public TerraStructureStart(NaturalSpawnType type, StructureGenerator<?> var0, int var1, int var2,
