...
public class NMSInjector extends NMSInjectorAbstract {
    ...
    public boolean attemptInject(@NotNull World world) {
        ...
        // long i
        NMSChunkGenerator bpg = new NMSChunkGenerator(world.getName(),
                (int) world.getSeed(),
                ws.k().g()
        ...
        // ws.k().g().d(),
        // world.getSeed());
        TerraformGeneratorPlugin.logger.info("NMSChunkGenerator Delegate is of type " + ws.k()
                                                                                          .g()
                                                                                          .getClass()
                                                                                          .getSimpleName());
        ...
        if (ws.k().g() instanceof CustomChunkGenerator) {
            try {
                ...
                TerraformGeneratorPlugin.logger.info("CustomChunkGenerator Delegate is of type " + delegate.getClass()
                                                                                                           .getSimpleName());
            }
            catch (Exception e) {
        ...
        try {
            TerraformGeneratorPlugin.privateFieldHandler.injectField(pcm, "u", bpg); // chunkGenerator
        }
        catch (Throwable e) {
            TerraformGeneratorPlugin.logger.stackTrace(e);
            return false;
