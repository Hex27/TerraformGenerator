...
public class PharoahsTombPopulator extends RoomPopulatorAbstract{
	...
	private void placePillar(Wall base, int height) {
		...
		for(BlockFace face:BlockUtils.directBlockFaces) {
			base.getRelative(face).Pillar(height, true, rand, Material.CUT_SANDSTONE,Material.CHISELED_SANDSTONE,Material.AIR,Material.AIR,Material.AIR,Material.CHISELED_SANDSTONE);
		}
