...
public class OutpostSchematicParser extends SchematicParser {
    ...
    public OutpostSchematicParser(BiomeBank biome, Random rand,
                                    PopulatorDataAbstract pop, int baseY) {
        this.biome = biome;
        this.rand = rand;
        this.pop = pop;
        this.baseY = baseY;
        toReplace = new Material[] {Material.COBBLESTONE, Material.COBBLESTONE, Material.COBBLESTONE, Material.MOSSY_COBBLESTONE};
    	if(biome == BiomeBank.BADLANDS || biome == BiomeBank.DESERT) 
    		 toReplace = new Material[] {Material.COBBLESTONE, Material.COBBLESTONE, Material.COBBLESTONE, Material.ANDESITE};
