...
public enum TConfigOption {
    ...
    HEIGHT_MAP_OCEANIC_FREQUENCY("heightmap.oceanic-frequency", 0.01f),
    HEIGHT_MAP_OCEANIC_THRESHOLD("heightmap.oceanic-threshold", 32f),
    HEIGHT_MAP_DEEP_OCEANIC_THRESHOLD("heightmap.deep-oceanic-threshold", 34f),
