...
public class OneOneNineBlockHandler {
    ...
    public static final @Nullable Material REINFORCED_DEEPSLATE = !Version.isAtLeast(19) ?
	...
	public static final @Nullable Material MUDDY_MANGROVE_ROOTS = !Version.isAtLeast(19) ?
