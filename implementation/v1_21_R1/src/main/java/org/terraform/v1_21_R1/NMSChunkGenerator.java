...
public class NMSChunkGenerator extends ChunkGenerator {
    ...
    public @NotNull CompletableFuture<IChunkAccess> a(RandomState randomstate,
                                                      Blender blender,
            ...
            if (holder.a().getClass() == StrongholdStructure.class) { // stronghold
                ...
                if (holder.a().getClass() == OceanMonumentStructure.class) { // Monument
                    ...
                    return new Pair<>(new BlockPosition(coords[0], 50, coords[1]), holder);
                         ...
                         && MinecraftServer.getServer().bc().d(Registries.aR).a(MinecraftKey.a("trial_chambers"))
                            == holder.a())
                { // Trial Chamber
                  ...
                  StructureTemplateManager structuretemplatemanager)
    {
        ...
        for (SingleMegaChunkStructurePopulator pop : spops) {
            if (!(pop instanceof VanillaStructurePopulator vpop)) {
                continue;
            }
            ...
            possibleStructureSets.stream()
                                 ...
                                 .forEach((structureSet) -> {
                                         ...
                                         && centerCoords[1] == chunkcoordintpair.f)
                                     {
                                         ...
                                         // d() -> getLevelSeed()
                                         try {
                                             Object retVal = tryGenerateStructure.invoke(this,
                                                     list.getFirst(),
                                                     structuremanager,
                                                     iregistrycustom,
                                                     randomstate,
                                             ...
                                             TerraformGeneratorPlugin.logger.info(chunkcoordintpair.e
                                                                                  + ","
                                                                                  + chunkcoordintpair.f
                                                                                  + " will spawn a vanilla structure, with tryGenerateStructure == "
                                                                                  + retVal);
                                         }
                                         catch (Throwable t) {
                                             TerraformGeneratorPlugin.logger.info(chunkcoordintpair.e
    ...
    public CompletableFuture<IChunkAccess> a(Blender blender,
                                             ...
                                             IChunkAccess ichunkaccess)
    {
        return delegate.a(blender, randomstate, structuremanager, ichunkaccess);
    }
