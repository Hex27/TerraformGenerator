...
public enum TConfigOption {
    ...
    BIOME_OCEAN_WEIGHT("biome.ocean.weight", 5),
    BIOME_BLACK_OCEAN_WEIGHT("biome.blackocean.weight", 2),
    BIOME_COLD_OCEAN_WEIGHT("biome.coldocean.weight", 5),
    BIOME_FROZEN_OCEAN_WEIGHT("biome.frozenocean.weight", 5),
    BIOME_WARM_OCEAN_WEIGHT("biome.warmocean.weight", 5),
    BIOME_HUMID_OCEAN_WEIGHT("biome.humidocean.weight", 5),
    BIOME_DRY_OCEAN_WEIGHT("biome.dryocean.weight", 5),
    BIOME_CORALREEF_OCEAN_WEIGHT("biome.coralreefocean.weight", 4),
    BIOME_DEEP_OCEAN_WEIGHT("biome.deepocean.weight", 5),
    BIOME_DEEP_COLD_OCEAN_WEIGHT("biome.deepcoldocean.weight", 5),
    BIOME_DEEP_BLACK_OCEAN_WEIGHT("biome.deepblackocean.weight", 1),
    ...
    DEVSTUFF_SUPPRESS_CONSOLE_LOGS("dev-stuff.suppress-terraform-console-logs", false),
    ...
    STRUCTURES_MONUMENT_SPAWNRATIO("structures.monument.spawn-ratio", 0.1),
    STRUCTURES_PYRAMID_ENABLED("structures.pyramid.enabled", true),
    STRUCTURES_PYRAMID_SPAWNRATIO("structures.pyramid.spawn-ratio", 0.1),
    STRUCTURES_PYRAMID_SPAWN_ELDER_GUARDIAN("structures.pyramid.spawn-elder-guardian", true),
    STRUCTURES_VILLAGEHOUSE_SPAWNRATIO("structures.villagehouse.spawnratio", 0.125),
    ...
    STRUCTURES_VILLAGE_SPAWNRATIO("structures.village.spawnratio", 0.125),
    ...
    STRUCTURES_SHIPWRECK_SPAWNRATIO("structures.shipwreck.spawnratio", 0.125),
    ...
    STRUCTURES_MINESHAFT_SPAWNRATIO("structures.mineshaft.spawnratio", 0.125),
    ...
    STRUCTURES_LARGECAVE_SPAWNRATIO("structures.largecave.spawnratio", 0.125),
