...
public abstract class PlainsVillageForgePiece extends JigsawStructurePiece {
	...
	public PlainsVillageForgePiece(int widthX, int height, int widthZ, JigsawType type, BlockFace[] validDirs) {
		super(widthX, height, widthZ, type, validDirs);
	}

	public PlainsVillageForgePiece(int widthX, int height, int widthZ, JigsawType type, boolean unique, BlockFace... validDirs) {
