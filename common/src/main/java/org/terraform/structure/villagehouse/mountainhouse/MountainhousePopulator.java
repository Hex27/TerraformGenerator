...
public class MountainhousePopulator extends VillageHousePopulator {
    ...
    public void spawnMountainhouse(TerraformWorld tw, Random random, PopulatorDataAbstract data, int x, int y, int z) {
        try {
    		...
    		new SphereBuilder(random, core.getUp(12), Material.AIR)
    		.setRX(17)
    		.setRZ(17)
    		.setRY(18)
    		.setMinRadius(0.7)
            ...
            .build(core.getFront(4).getRight(4).getUp(4))
            .build(core.getFront(4).getRight(7).getUp(4));

            new StairwayBuilder(Material.STONE_STAIRS, Material.COBBLESTONE_STAIRS, Material.ANDESITE_STAIRS)
            .setAngled(false)
            .setMaxExtensionForward(10)
            .setStairwayDirection(BlockFace.DOWN)
            .build(core.getFront(4).getRight(5).getUp(4))
            .build(core.getFront(4).getRight(6).getUp(4));

            new StairwayBuilder(Material.SPRUCE_STAIRS)
            .setAngled(false)
