    ...
    public void populate(@NotNull PopulatorDataAbstract data, @NotNull CubeRoom room) {
        ...
        if(Version.isAtLeast(20))
            for(int i = 0; i < rand.nextInt(4); i++)
            {
                ...
                data.lootTableChest(coords[0],room.getY(),coords[2], GenUtils.chance(rand,1,3) ? TerraLootTable.TRAIL_RUINS_ARCHAEOLOGY_RARE: TerraLootTable.TRAIL_RUINS_ARCHAEOLOGY_COMMON);
            }
    }
